...
class HookLoggerService {
  ...
  async info(msg: string, component: LogComponent, fields?: Record<string, unknown>): Promise<void> {
    await this.log('INFO', msg, component, fields);
  }

  async warn(msg: string, component: LogComponent, fields?: Record<string, unknown>): Promise<void> {
    await this.log('WARN', msg, component, fields);
  }

  async error(msg: string, component: LogComponent, fields?: Record<string, unknown>): Promise<void> {
    await this.log('ERROR', msg, component, fields);
  }

  async debug(msg: string, component: LogComponent, fields?: Record<string, unknown>): Promise<void> {
